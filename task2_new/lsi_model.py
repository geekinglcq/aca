...
def extract_training_paper_for_interest(train_author,t_author_paper,author_interest):
    ...
    print ("extract training paper for interest ...")
    interest_paper = {}
...
def print_validation_result(predict_author_interest,author_list,author_interest):
    ...
    with codecs.open("result_predict_by_interest_valimany.txt","a","utf-8") as fid:
        ...
        print ("lsi model accuracy : " + str(accuracy/1000))
...
def lsi_main(t_author_paper,author_interest,p_author_paper,train_author,vali_author,flag):
    ...
    if flag == 'vali':
        ...
        predict_author_interest,predict_author_interest_score = predict_n_interest(t_author_paper,interest_seq,dictionary,corpus,tfidf_model,lsi_model,corpus_simi_matrix)
        print_validation_result(predict_author_interest,vali_author,author_interest)
    if flag == 'test':
        predict_author_interest,predict_author_interest_score = predict_n_interest(p_author_paper,interest_seq,dictionary,corpus,tfidf_model,lsi_model,corpus_simi_matrix)
