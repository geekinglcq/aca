    ...
    for su in range(150,160,20):
        ...
        for vali_n in range(40,45,5):
            for num_topics in range(200,250,50):
                ...
                if flag == 'vali':
                    predict_author_interest,predict_author_interest_score = predict_n_interest(vali_author_paper,author_train,author_interest,dictionary,corpus,tfidf_model,lsi_model,corpus_simi_matrix,vali_n,su)
