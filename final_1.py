...
raw_data_path = './full_data/full_data.tsv'
model_path = './model/hv5-py35.dat'
...
def main():
    ...
    # res = crawler.multi_thread_get_search_page(data, threads_num=15)
    ...
    # crawler.store_multi_thread(data, threads=15, prefix='./final/')
    ...
    # succ = crawler.multi_thread_download_image(pic_urls, threads_num=15)
    ...
    logging.info('predict email cost %s'%(time.time() - time.stamp))
    time_stamp = time.time()
