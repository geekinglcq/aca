...
def predict_n_interest(p_author_paper,author_seq,author_interest,dictionary,corpus,tfidf_model,lsi_model,corpus_simi_matrix,vali_n,su):
    ...
    #with codecs.open("./vali_result/p_925_20.json","w","utf-8") as fid:
...
def print_validation_result(predict_author_interest,author_seq,author_interest,num_topics):
    print ("validation result ...")

    print (len(author_interest.keys()))
    print (len(predict_author_interest.keys()))

    with codecs.open("./vali_result/result_accuracy.txt","a","utf-8") as fid:
        accuracy = 0
        ...
        fid.write(str(num_topics)+'\t'+str(accuracy/1000)+'\n')
        print (accuracy/1000)
...
if __name__ =="__main__":
    ...
    for su in range(150,160,20):
        ...
        for vali_n in range(46,48,5):
            (tfidf_model,lsi_model,corpus_simi_matrix)=create_lsi_model(120,dictionary,corpus)
            predict_author_interest = predict_n_interest(vali_author_paper,author_train,author_interest,dictionary,corpus,tfidf_model,lsi_model,corpus_simi_matrix,vali_n,su)
            ...
            print_validation_result(predict_author_interest,author_seq,author_interest,vali_n)
